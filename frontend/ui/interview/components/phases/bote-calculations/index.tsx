...
export function BotECalculationStep() {
  ...
  const { messages, sendMessage } = useInterviewChat({
    phaseLabel: Schemas.InterviewPhaseLabelEnum.BotECalculation,
  });
      ...
      <div className="p-4 border-b bg-white flex justify-between items-center">
        <div>
          <h2 className="font-semibold text-lg">
            Phase 2: Back-of-the-Envelope Calculations
          </h2>
          <p className="text-sm text-muted-foreground">
            Estimate scale, storage, bandwidth, and other quantitative
            requirements.
          </p>
        </div>
      </div>
