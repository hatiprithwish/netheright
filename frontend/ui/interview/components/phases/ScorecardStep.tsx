      ...
      <div className="max-w-4xl mx-auto space-y-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="bg-white p-6 rounded-xl shadow-sm border text-center flex flex-col justify-center items-center">
                <h3 className="text-lg font-medium text-muted-foreground mb-4">Overall Grade</h3>
        ...
        <div className="bg-white p-6 rounded-xl shadow-sm border">
            ...
            <p className="text-muted-foreground">Analysis pending real backend implementation...</p>
        </div>
      </div>
    </div>
  );
